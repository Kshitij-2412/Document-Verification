...
folder_path = r"C:\Users\kshit\Downloads\DocumentVerifcation\DocumentVerifcation\Cheque\Dataset\Real"  # Specify the path to the folder containing the images
prefix = "Real_Cheque_"
count = 1
