...
folder_path = r"C:\Users\kshit\Downloads\DocumentVerifcation\DocumentVerifcation\Cheque\Dataset\Fake"  # Specify the path to the folder containing the images
prefix = "Fake_Cheque_"
count = 1
