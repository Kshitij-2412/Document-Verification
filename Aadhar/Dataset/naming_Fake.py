...
folder_path = r"C:\Users\kshit\Downloads\DocumentVerifcation\DocumentVerifcation\Aadhar\Dataset\Fake"  # Specify the path to the folder containing the images
prefix = "Fake_Aadhar_"
count = 1
